...
###   should be saved as tacsatEflalo_"Year".rds (eg. tacsatEflalo_2016.rds)
...
fwrite(out1, paste0(resPath, "landings_N2k.csv"))
...
fwrite(nov, paste0(resPath, "NoVessels.csv"))
...
fwrite(out4, paste0(resPath, "landings_rect.csv"))
...
fwrite(out7, paste0(resPath, "comp.csv"))
...
#gilnets in 2012 (since mapview cant handle very large datasets)               
st_geometry(dat1) <- dat1$geometry
mapview(dat1[dat1$LE_YEAR==2012 & dat1$LE_GEAR=="GN",], zcol="LE_KG_TOT")
