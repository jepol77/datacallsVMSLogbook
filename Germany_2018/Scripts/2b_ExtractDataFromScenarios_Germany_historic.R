...
intermediatePath <- paste0(sysPath,"int/historic/")
resPath     <- paste0(sysPath,"Results/historic/")
...
for (Year in c(2005:2017)) {
  ...
  #Only use vessels more than or equal to 15 meters.
  te <- te[VE_LEN>=15]
  ...
  #Dont include TBC 
  Bottom_Trawls <- c("TBB", "OTB", "PTB", "OTT", "TB", "TBN", "TBS", "SB", "SDN", "SSC", "SPR", "SX", "SV", "DRB", "DRH", "HMD")
